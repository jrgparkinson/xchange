  ...
  function reload_trades(div, active, investor_id) {
    ...
    $.ajax({
      ...
      data: opts
        ...
        response.trades.forEach(trade => {
          ...
          var newRow = '<tr class="trade ' + trade.type.toLowerCase() + ' ' + trade.status.toLowerCase() + '">';
